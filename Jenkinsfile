pipeline {
    ...
    environment {
        ...
        REPO_URL = 'https://github.com/rayhanegar/twitah-devsecops.git'
        BRANCH = 'main'
        APP_PATH = '/home/dso505/twitah-devsecops'
        SNS_PATH = '/home/dso505/sns-devsecops'
        APP_URL = 'http://sns.devsec505.com'
    }
